...
An R package for querying the PubMed database & parsing retrieved records.  
...
The `pmed_crosstab_query` can be used to build a cross-tab of PubMed search results for multiple search terms.
