...
```{r}
pmids <- pubmedtk::search_pubmed('ethnobotany', use_pub_years = F)
...
recs_pubmed1 <- recs_pubmed|>
  textpress::nlp_split_paragraphs() 
  textpress::nlp_split_sentences(by = c('doc_id', 'paragraph_id'))
